...
function setPostEnv()

    {
      ...
      global $searchFunction, $searchWen, $searchRegistered, $searchAgent, $searchEnv, $basedn, $saveDN, $savePassword, $saveResetPassword, $saveRegistered, $dwnList;
...
function setLDAPEnv() {
      ...
      global $ldaprdn, $ldappass, $attributes, $server_name, $port;
      global $searchFunction, $searchWen, $searchRegistered, $searchAgent, $searchEnv, $basedn, $saveDN, $savePassword, $saveResetPassword, $saveRegistered, $dwnList;
...
function queryDir() {
	...
	<td scope="col"><input name=searchWen type=text value="<?php if ($searchWen != "") { echo $searchWen; } ?>"></input></td>
	<td scope="col">	
